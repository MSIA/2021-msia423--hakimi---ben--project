...
if __name__ == '__main__':
    ...
    sb_datatos3.add_argument("--FILEPATH", default = "data.csv", help="name of data to upload")
    ...
    sb_datatos3.add_argument("--OUTPUTPATH", default = "data.csv", help="name of output after download")
